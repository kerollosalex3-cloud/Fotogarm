...
const images = [
  {
    src: "imges/img1.jpg",
    alt: "Türkisfarbener Gletschersee mit Eisbergen und Bergen",
  },
  {
    src: "imges/img2.jpg",
    alt: "Regnerische Straße in Japan bei Nacht mit Neonlichtern",
  },
  ...
  {
    src: "imges/img6.jpg",
    alt: "Ruhiger See mit schneebedeckten Bergen und Spiegelung",
  },
  {
    src: "imges/img7.jpg",
    alt: "Ente mit ausgebreiteten Flügeln auf dem Wasser",
  },
  {
    src: "imges/img8.jpg",
    alt: "Person steht nachts auf einem Felsen am Meer unter Sternenhimmel",
  },
  {
    src: "imges/img9.jpg",
    alt: "Kleiner weiß-brauner Vogel sitzt auf einem Felsen",
  },
  {
    src: "imges/img10.jpg",
    alt: "Zwei junge Schneeleoparden auf einem Felsen",
  },
  { src: "imges/img11.jpg", alt: "Schneebedeckte Berge unter blauem Himmel" },
  {
    src: "imges/img12.jpg",
    alt: "Einzelner verschneiter Baum in Winterlandschaft",
  },
];
...
function navigate(direction) {
  updateCurrentIndex(currentIndex + direction);
  displayImage();
}
